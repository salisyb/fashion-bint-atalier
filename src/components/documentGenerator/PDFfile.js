...
const data = {
  invoice_owner: "Bappi Kabir",
  date: "Aug 20 2022",
  collection_data: "Aug 30 2022",
};
...
export const MyDocument = () => (
  <Document>
    <Page size={"A4"} style={styles.page}>
      ...
      <View style={styles.subHeaderWrapper}>
        ...
        <View style={styles.invoiceInfoWrapper}>
          ...
          <View>
            ...
            <Text style={styles.text}>{data.collection_data}</Text>
          </View>
        </View>
      </View>
      ...
      <View style={{ marginTop: "10px" }}>
        <Text style={{ fontSize: "14px" }}>
          Dear Esteemed Client You are to either pay 50% deposit or full payment
          of your service charge to enable us to start processing your outfits.
          Please send Proof of Payment to enable us serve you better. Charges of
          N2000 applies 3 days after your date of collection. NO REFUND ❌ THANK
          YOU
        </Text>
      </View>
      <View style={styles.divider} />
      ...
      >
        ...
        {/* custormer sign */}
        <View style={{ display: "flex", alignItems: "center" }}>
          <Text style={{ fontSize: "16px" }}>Bappi Kabir</Text>
          <Image
            src={"https://i.postimg.cc/66F6VvPg/bint-sign-removebg-preview.png"}
            style={{ width: "80px" }}
          />
